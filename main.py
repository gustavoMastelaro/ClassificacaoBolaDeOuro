...
def main():
    print("=== Inicializando o projeto de previsão do Ballon D'or ===")
    
    # 1. Inicializa o CSV (cria o diretório e o arquivo se não existirem)
    init_csv()
    ...
    jogadores_teste = [
        ...
        },
        {
            ...
            "N° de Gols": 23,
            "N° de Assistências": 13,
            "Ranking FIFA": 4,
            "Conquista de títulos na temporada": 3,
            "Valor de mercado": 180000000.0,
            "Nota Média de desempenho": 7.9,
            "Clean Sheet": 0,
            "MOTM": 6
        },
        {
            "Nome do Jogador": "Kylian Mbappé",
            "N° de Gols": 44,
            "N° de Assistências": 10,
            "Ranking FIFA": 2,
            "Conquista de títulos na temporada": 2,
            "Valor de mercado": 180000000.0,
            "Nota Média de desempenho": 8.2,
            "Clean Sheet": 0,
            "MOTM": 9
        },
        {
            ...
            "N° de Gols": 9,
            "N° de Assistências": 14,
            "Ranking FIFA": 8,
            "Conquista de títulos na temporada": 4,
            "Valor de mercado": 120000000.0,
            "Nota Média de desempenho": 8.4,
            "Clean Sheet": 0,
            "MOTM": 8
        }
    ]
    ...
    print("\nRecalculando ranking de forma explícita...")
    recalculate_ranking()
    ...
    if os.path.exists(DEFAULT_CSV_PATH):
        ...
        # Selecionando colunas mais relevantes para a visualização no terminal
        colunas_exibicao = [
            "Nome do Jogador", 
            "N° de Gols", 
            "N° de Assistências", 
        ...
        print("Erro: Arquivo CSV de ranking não foi encontrado.")
